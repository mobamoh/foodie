package com.mohamedbamoh.foodie.kafka.consumer.config;

import com.mohamedbamoh.foodie.kafka.config.data.KafkaConfigData;
import com.mohamedbamoh.foodie.kafka.config.data.KafkaConsumerConfigData;
