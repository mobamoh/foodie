package com.mohamedbamoh.foodie.restaurant.data.access.outbox.adapter;

import com.mohamedbamoh.foodie.outbox.OutboxStatus;
import com.mohamedbamoh.foodie.restaurant.data.access.outbox.exception.OrderOutboxNotFoundException;
import com.mohamedbamoh.foodie.restaurant.data.access.outbox.mapper.OrderOutboxDataAccessMapper;
import com.mohamedbamoh.foodie.restaurant.data.access.outbox.repository.OrderOutboxJpaRepository;
import com.mohamedbamoh.foodie.restaurant.domain.app.service.outbox.model.OrderOutboxMessage;
import com.mohamedbamoh.foodie.restaurant.domain.app.service.port.output.repository.OrderOutboxRepository;
