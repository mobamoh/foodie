package com.mohamedbamoh.foodie.order.data.access.outbox.restaurant.adapter;

import com.mohamedbamoh.foodie.order.data.access.outbox.restaurant.exception.ApprovalOutboxNotFoundException;
import com.mohamedbamoh.foodie.order.data.access.outbox.restaurant.mapper.ApprovalOutboxDataAccessMapper;
import com.mohamedbamoh.foodie.order.data.access.outbox.restaurant.repository.ApprovalOutboxJpaRepository;
